...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why? greedy porque buscamos a maior quantidade de caracteres possíveis
  #
  # non-greedy ou lazy: busca a menor quantidade de caracteres possíveis
  ...
  # character class ([...]) Serve para descrever um conjunto de dados que devem ser encontrados
  # de forma individual
  # alternation (|) Serve para descrever um conjunto de dados que devem ser encontrados
  # de forma individual ou em conjunto
